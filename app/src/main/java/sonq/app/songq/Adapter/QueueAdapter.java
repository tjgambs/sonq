...
public class QueueAdapter extends RecyclerView.Adapter<QueueAdapter.QueueViewHolder> {
    ...
    public static class QueueViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            parent.onClickedPlayPreview(song);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public QueueAdapter(List<SearchResult> songList, FragmentQueue parent) {
        this.parent = parent;
    ...
    public void onBindViewHolder(QueueViewHolder holder, int position) {
        ...
        SearchResult song = songList.get(position);
        // Get Image
    ...
    public void update(List<SearchResult> data) {
        songList.clear();
